                    ...
                    <div class="col-12">
                        <div class="card res_table">
                            <div class="card-header">
                                ...
                                <a href="{{route('admin.slider.create')}}" class="float-left btn btn-primary"><i class="fa fa-circle-o mtp-1 ml-1"></i>افزودن</a>
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    @if(count($tours)>0)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center vertical-align-middle">
                                                <a href="{{route('admin.ads-tours.edit',$item->id)}}" class="badge bg-primary ml-1" title="ویرایش"><i class="fa fa-edit"></i> </a>
